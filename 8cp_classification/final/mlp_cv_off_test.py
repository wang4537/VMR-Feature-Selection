...
#training data
train =  pandas.read_csv("../project_data/Opt_off_cp_train_data.csv")
#testing data
test = pandas.read_csv("../project_data/Opt_off_cp_test_data.csv")
#encode the genotype
...
cv_out = pandas.read_csv("../CV/MLP/MLP_Opt_off_CP_cv.csv", sep = ',', decimal = '.')
