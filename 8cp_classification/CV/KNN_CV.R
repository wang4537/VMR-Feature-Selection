...
CV_list <- foreach(i = 1:length(fold_uid_list), .packages = c("class", "pROC", "caret")) %dopar% {
  ...
  score_df <- as.data.frame(kNN_k_acc(train_fold[,-1], valid_fold[-1], kNN_parameters))
