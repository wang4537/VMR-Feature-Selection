...
#### Main ####
library(ggplot2)
setwd("Y:/data/Feature_selection_framework/2.1ave_plot/")
#read all normalized data into a list
on <- read.csv("../2preprocess_sep/Opt_on_train_norm.csv")
off <- read.csv("../2preprocess_sep/Opt_off_train_norm.csv")
